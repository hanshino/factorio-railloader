...
data:extend{
  -- buildable entity, immediately replaced by scripting
  {
    ...
    icon_size = 32,
    minable = { mining_time = 0.1, results = {{type = "item", name = "railunloader", amount = 1}} },
    ...
    circuit_connector = circuitconnectors["railloader-placement-proxy"],
...

  {
    ...
    icon = "__railloader-continued__/graphics/icons/railunloader.png",
    icon_size = 32,
    flags = {"hide-alt-info"},
  ...
  -- interactable inventory
  {
    ...
    minable = {mining_time = 0.5, results = {{type = "item", name = "railunloader", amount = 1}}},
...
univ.localised_name = {"entity-name.railunloader-inserter"}
